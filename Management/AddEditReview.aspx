        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Body" SortExpression="Body">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ErrorMessage="Enter a body" ControlToValidate="TextBox3" runat="server" />
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Body") %>' TextMode="MultiLine" Width="500" Height="100"></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="Enter a body" ControlToValidate="TextBox3" runat="server" />
            ...
            <asp:TemplateField HeaderText="GenreId" SortExpression="GenreId">
                ...
                <InsertItemTemplate>
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="GenresDataSource" DataTextField="Name" DataValueField="Id" SelectedValue='<%# Bind("GenreId") %>'></asp:DropDownList>
                </InsertItemTemplate>
