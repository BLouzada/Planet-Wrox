...
<asp:Panel ID="VerticalPanel" runat="server">
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="../Images/Banner120x240.gif" AlternateText="This is a sample" />
    </a>
</asp:Panel>
<asp:Panel ID="HorizontalPanel" runat="server">
    <a href="http://p2p.wrox.com" target="_blank" runat="server" id="HorizontalLink">
    <asp:Image ID="Image2" runat="server" ImageUrl="../Images/Banner486x60.gif" AlternateText="This is a sample" />
    </a>
</asp:Panel>